...
| Infrastructure | Agent drafts Dockerfile/CI, I inspect against a red-flag list (no `continue-on-error`, no `\|\| true`, pinned versions) and demand runtime proof — a green check is only trusted after an intentional red. |
